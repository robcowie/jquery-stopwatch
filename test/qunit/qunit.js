    ...
    addEvent(window, "load", function() {
        ...
        if (banner) {
            banner.innerHTML = '<a href="' + QUnit.url({
                filter: undefined
            }) + '"> ' + banner.innerHTML + '</a> ' + '<label><input name="noglobals" type="checkbox"' + (config.noglobals ? ' checked="checked"' : '') + '>noglobals</label>' + '<label><input name="notrycatch" type="checkbox"' + (config.notrycatch ? ' checked="checked"' : '') + '>notrycatch</label>';
            ...
            parsers: {
                ...
                node: function(node) {
                    ...
                    for (var a in QUnit.jsDump.DOMAttrs) {
                        ...
                        if (val) ret += ' ' + a + '=' + QUnit.jsDump.parse(val, 'attribute');
                    }
